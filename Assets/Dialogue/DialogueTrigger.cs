...
public class PhaedrusWalk : MonoBehaviour
{
    ...
    [SerializeField] private string joinNode = "Part1_Intro_Ch1_RealLife";
    ...
    [SerializeField] private float sideOffset = 1.5f;     // how far to your side
    [SerializeField] private float forwardOffset = 0.5f;  // slightly ahead of you
    ...
    void Follow()
{
    // the spot beside you where he should be
